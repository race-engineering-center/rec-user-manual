...
1. Открыть окно скриптов (см. [Скрипты](scripts.ru.md))
1. Открыть библиотеку кругов (см. [Библиотека кругов](laplibrary.ru.md))
1. Открыть окно Garage61 (см. [Garage61](cloud_db.ru.md))
1. Открыть настройки (см. [Настройки](preferences.ru.md))
...
их в список кругов. Подробнее — в разделе [Библиотека кругов](laplibrary.ru.md).
